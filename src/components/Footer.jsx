...
function Footer() {
    return (
        <footer className='dark:bg-black bg-white text-black dark:text-white'>
                ...
                <div className="grid grid-cols-1 gap-8 text-center mx-auto">
                    <div>
                        <p className="font-signika">
                            <b>
                                Pravesh <span style={{ color: "chocolate" }}>Chaudhary</span>
                            </b>
                        </p>
                        <p className="mt-4 text-sm text-gray-600 dark:text-gray-300">
                            T 650/H 1 Baljeet Nagar
                            <br />
                            Delhi, 11008
                        </p>
                        <div className="flex mx-auto">
                            <div className="mx-auto space-x-6 flex mt-8 text-gray-600 dark:text-gray-300 items-center">
                                <a
